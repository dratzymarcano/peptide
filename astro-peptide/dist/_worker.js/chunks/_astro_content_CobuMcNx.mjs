...
import { ao as objectType, ap as dateType, aq as arrayType, ar as stringType, A as AstroError, as as UnknownContentCollectionError, c as createComponent, at as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, h as escape, au as renderUniqueStylesheet, av as renderScriptElement, aw as createHeadAndContent, r as renderComponent } from './astro/server_DjzMfJVp.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BQ7TJVSo.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://peptide-shop.net", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CX9wVnX2.mjs').then(n => n._);
