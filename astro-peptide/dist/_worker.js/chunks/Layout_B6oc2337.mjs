...
import { d as createAstro, c as createComponent, a as renderTemplate, r as renderComponent, e as addAttribute, m as maybeRenderHead, b as renderScript, am as renderSlot, an as renderHead, u as unescapeHTML } from './astro/server_DjzMfJVp.mjs';
import { a as requireReact, b as reactExports } from './_@astro-renderers_Co1rHHJa.mjs';
/* empty css                              */
...
function CartIcon({ lang = "en" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        ` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-modal-container fixed z-[10011] bg-white flex flex-col shadow-2xl overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-4 border-b border-gray-100", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-slate-800 m-0", children: t(lang, "cart.yourCartCount").replace("{count}", String(items.length)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: handleClose,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4", children: isEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-10 text-slate-500", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "64", height: "64", viewBox: "0 0 24 24", fill: "none", stroke: "#cbd5e1", strokeWidth: "1.5", className: "mx-auto mb-4", style: { display: "block", margin: "0 auto 16px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "9", cy: "21", r: "1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "20", cy: "21", r: "1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-lg mb-2", children: t(lang, "cart.empty") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-6", children: t(lang, "cart.addProductsToGetStarted") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
            ...
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4", style: { display: "flex", flexDirection: "column", gap: "16px" }, children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 flex flex-col justify-between py-1", style: { flex: 1 }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "m-0 text-sm font-bold text-slate-800 leading-tight", style: { margin: 0, fontSize: "0.9rem", fontWeight: 600 }, children: item.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-end mt-2", style: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginTop: "8px" }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "m-0 font-bold text-[#0077b6]", style: { color: "#0077b6", margin: 0 }, children: formatPrice(item.price, currency) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center bg-white border border-slate-200 rounded-lg h-8", style: { display: "flex", alignItems: "center", border: "1px solid #e2e8f0", borderRadius: "6px" }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 text-center text-sm font-semibold text-slate-800", style: { minWidth: "24px", textAlign: "center", fontWeight: 600 }, children: item.quantity }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
            ...
            !isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-t border-gray-100 bg-white pb-[max(1rem,env(safe-area-inset-bottom))]", style: { padding: "16px", borderTop: "1px solid #f1f5f9", paddingBottom: "max(16px, env(safe-area-inset-bottom))" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-end mb-1", style: { display: "flex", justifyContent: "space-between", marginBottom: "4px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-600 font-medium", children: t(lang, "cart.subtotal") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-slate-900", children: formatPrice($cartTotal, currency) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-400 mb-4 text-right", style: { fontSize: "0.75rem", color: "#94a3b8", textAlign: "right", marginBottom: "16px" }, children: "Shipping & taxes calculated at checkout" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", style: { display: "flex", flexDirection: "column", gap: "12px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "20 6 9 17 4 12" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 600, fontSize: "0.95rem" }, children: t(lang, "cart.addedToCart") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: handleClose,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px", display: "flex", gap: "12px", alignItems: "center" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { margin: 0, fontSize: "0.95rem", fontWeight: 700, color: "#0077b6" }, children: [
              "£",
...
function AccountButton({ lang = "en" }) {
  ...
  if ($isAuthenticated && $currentUser) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: dropdownRef, style: { position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            $currentUser.avatar ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "action-label", style: { maxWidth: "100px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: displayName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", style: { marginLeft: "2px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: "6 9 12 15 18 9" }) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: dropdownStyle, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "12px 14px", borderBottom: "1px solid #f1f5f9", marginBottom: "8px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontWeight: "700", color: "#1e293b", marginBottom: "2px" }, children: [
            $currentUser.firstName,
            " ",
            $currentUser.lastName
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "12px", color: "#64748b" }, children: $currentUser.email })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#0077b6", strokeWidth: "2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: "1px solid #f1f5f9", marginTop: "8px", paddingTop: "8px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: () => {
              logout();
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#ef4444", strokeWidth: "2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "21", x2: "9", y1: "12", y2: "12" })
              ] }),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            className: "account-btn",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "action-label", children: t(lang, "nav.account") })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: dropdownStyle, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px 14px", textAlign: "center", borderBottom: "1px solid #f1f5f9", marginBottom: "8px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
              width: "48px",
              height: "48px",
              borderRadius: "50%",
              ...
              justifyContent: "center",
              margin: "0 auto 12px"
            }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "#0077b6", strokeWidth: "2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "7", r: "4" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: "600", color: "#1e293b", marginBottom: "4px" }, children: t(lang, "common.welcome") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "13px", color: "#64748b" }, children: t(lang, "common.signInForBestExperience") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, height: "1px", background: "#e2e8f0" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "12px", color: "#94a3b8" }, children: t(lang, "common.or") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, height: "1px", background: "#e2e8f0" } })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "8px" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" }) }),
                  "Facebook"
                ]
              }
            )
...
function SearchBar({ lang = "en" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: containerRef, className: "position-relative", children: !isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
  ...
  ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-container", style: { minWidth: "280px" }, children: [
    ...
    (results.length > 0 || isLoading) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 text-center text-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: t(lang, "common.searching") }) }) : results.map((result) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: result.slug,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                ...
                result.type === "product" && /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
                ...
                result.type === "blog" && /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
                ...
                result.type === "page" && /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { overflow: "hidden" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 500, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: result.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("small", { className: "text-muted", style: { textTransform: "capitalize" }, children: result.category })
              ] })
            ]
          },
          result.id
    ...
    query.length >= 2 && !isLoading && results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: t(lang, "common.noResultsFound").replace("{query}", query) }) })
      }
    )
  ] }) });
}
...
const FlagIcon = ({ lang }) => {
  switch (lang) {
    case "en":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 640 480", className: "w-full h-full object-cover", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#012169", d: "M0 0h640v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#FFF", d: "m75 0 244 181L562 0h78v62L400 241l240 178v61h-80L320 301 81 480H0v-60l239-178L0 64V0h75z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#C8102E", d: "m424 281 216 159v40L369 281h55zm-184 20 6 35L54 480H0l240-179zM640 0v3L391 191l2-44L590 0h50zM0 0l239 176-26 35L0 47V0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#FFF", d: "M241 0v480h160V0H241zM0 160v160h640V160H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#C8102E", d: "M0 193v96h640v-96H0zM273 0v480h96V0h-96z" })
      ] });
    case "nl":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 640 480", className: "w-full h-full object-cover", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#21468B", d: "M0 0h640v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#FFF", d: "M0 0h640v320H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#AE1C28", d: "M0 0h640v160H0z" })
      ] });
    case "de":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 640 480", className: "w-full h-full object-cover", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#FFCE00", d: "M0 0h640v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#000", d: "M0 0h640v160H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#DD0000", d: "M0 160h640v160H0z" })
      ] });
    case "fr":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 640 480", className: "w-full h-full object-cover", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#EF4135", d: "M0 0h640v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#FFF", d: "M0 0h427v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#0055A4", d: "M0 0h213v480H0z" })
      ] });
    case "es":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 640 480", className: "w-full h-full object-cover", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#AA151B", d: "M0 0h640v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#F1BF00", d: "M0 120h640v240H0z" })
      ] });
    case "it":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 640 480", className: "w-full h-full object-cover", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#CE2B37", d: "M0 0h640v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#FFF", d: "M0 0h427v480H0z" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#009246", d: "M0 0h213v480H0z" })
      ] });
    default:
      return null;
  }
...
function LanguageSwitcher({ currentLang = "en" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative font-sans text-left", ref: dropdownRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-6 h-6 rounded-full overflow-hidden shadow-sm shrink-0 ring-1 ring-slate-100 group-hover:ring-slate-200 transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FlagIcon, { lang: currentLang }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-slate-700 tracking-wide uppercase", children: currentLang }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-xs font-medium text-slate-400 uppercase tracking-wider", children: "Select Language" }),
          Object.keys(languages).map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-8 h-6 rounded overflow-hidden shadow-sm relative shrink-0 transition-transform duration-300 group-hover:scale-105
                 ${lang === currentLang ? "ring-2 ring-white" : "ring-1 ring-slate-100 opacity-80 group-hover:opacity-100"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FlagIcon, { lang }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 relative z-10", children: getLanguageName(lang) }),
                lang === currentLang && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
                    width: "12",
                    height: "12",
...
export { $$Layout as $, getLocalizedPath as a, translatePackageSize as b, cleanProductTitle as c, translateCategory as d, currentCurrency as e, formatPrice as f, getLangFromUrl as g, exchangeRate as h, addCartItem as i, jsxRuntimeExports as j, translateProductContent as k, getLocalizedPageTitle as l, getLocalizedMetaDescription as m, translateFAQs as n, translateReviews as o, getLocalizedProductSlug as p, pageSlugTranslations as q, productSlugTranslations as r, supportedLanguages as s, t, useStore as u, getMarket as v, translations as w };
